...
export const projects: Project[] = [
  {
    ...
    businessObjective: "Designed a live tracking system for an open-pit mine's digger–crusher supply chain, cleaning and preparing raw operational data using MySQL Workbench to track inventory levels and key operational metrics in near real time.",
    ...
    approach: "Cleaned and prepared raw operational data using MySQL Workbench; built dashboards to track inventory levels and key operational metrics in near real time; presented findings and recommendations to a simulated technical audience via a concise slide deck.",
    ...
    businessImpact: "Presented findings and recommendations to a simulated technical audience via a concise slide deck for operational decision-making.",
