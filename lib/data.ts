...
export const projects: Project[] = [
  {
    title: "Supply Chain Analytics — Capstone Project",
    tagline: "IIIT Bangalore Capstone Project: Designing a near real-time operational tracking system for open-pit mining.",
    problem: "Open-pit mining operations require efficient equipment coordination between diggers and crushers to avoid unplanned idling, bottlenecking, and inventory throughput delays.",
    businessObjective: "Design a live tracking system for an open-pit mine's digger–crusher supply chain, cleaning and preparing raw operational data using MySQL Workbench to track inventory levels and key operational metrics in near real time.",
    dataset: "Raw operational mining equipment data, digger-crusher cycle times, haul truck dispatch logs, and tonnage records.",
    toolsUsed: ["MySQL Workbench", "Tableau", "Power BI", "PowerPoint"],
    approach: "Cleaned and prepared raw operational data using MySQL Workbench; built dashboards in Power BI/Tableau to track inventory levels and key operational metrics in near real time; presented findings and recommendations to a simulated technical audience via a concise slide deck.",
    dashboard: "Near real-time interactive Power BI and Tableau dashboards tracking inventory levels, equipment performance, and key operational metrics.",
    keyInsights: [
      "Identified inventory throughput variations and equipment operational performance metrics across the digger-crusher supply chain.",
      "Uncovered key equipment utilization trends to support near real-time operational tracking and management.",
    ],
    businessImpact: "Presented actionable findings and recommendations to a simulated technical audience via a concise slide deck for operational decision-making.",
    learning: "Gained hands-on experience in raw operational data cleaning in MySQL Workbench, dimensional KPI tracking, and executive slide presentation.",
    github: null,
    demo: null,
  ...
  },
  {
    ...
    businessObjective: "Perform EDA and data wrangling on a credit card dataset to uncover customer spending patterns, segment-level trends, and risk indicators for business intelligence reporting.",
    ...
    approach: "Identified data quality issues (missing values, outliers); applied data cleaning and wrangling techniques; generated visualized insights for business intelligence reporting.",
    dashboard: "Python visual exploratory suite with spend distribution plots, category heatmaps, and segment risk summaries.",
    keyInsights: [
      "Uncovered key customer spending patterns and segment-level transaction trends.",
      "Identified data quality anomalies (missing values, outliers) and produced a validated analytical dataset.",
    ],
    businessImpact: "Delivered visualized insights for business intelligence reporting to support data-driven decision-making.",
  ...
  },
  {
    ...
    businessObjective: "Build a linear regression model with feature engineering to predict daily bike rentals through iterative pipeline optimization and feature selection.",
    ...
    approach: "Built a linear regression model; performed feature engineering, iterative pipeline optimization, and feature selection; tracked model KPIs (RMSE, R²) across iterations.",
    dashboard: "Python model evaluation suite tracking RMSE and R² metrics across pipeline iterations.",
    keyInsights: [
      "Achieved strong predictive model performance through systematic feature selection and pipeline optimization.",
      "Evaluated model KPIs (RMSE, R²) across iterations to validate feature predictive power.",
    ],
    businessImpact: "Presented findings with data-driven recommendations to support operational planning.",
  ...
  },
  {
    ...
    businessObjective: "Derive actionable business intelligence insights from a large movie dataset using complex SQL queries, subqueries, and window functions.",
    ...
    keyInsights: [
      "Extracted multi-dimensional business intelligence insights across movie ratings, regional box office trends, and genres.",
  ...
  },
  {
    ...
    tagline: "Team Project: Modeling employee retention risk factors from HR data for proactive decision-making.",
    problem: "Organizations require data-driven visibility into workplace retention factors to reduce voluntary employee turnover.",
    businessObjective: "Model employee attrition risk from HR data, translating model output into retention-risk factors for organizational planning.",
    dataset: "HR analytics dataset containing employee satisfaction scores, evaluation ratings, tenure, project load, and exit logs.",
    toolsUsed: ["Python", "Scikit-learn", "Pandas"],
    approach: "Performed EDA and class balance handling; trained predictive classification models; extracted feature importance rankings to identify key retention risk factors.",
    dashboard: "Python model evaluation suite displaying retention risk factors and employee attrition probabilities.",
    keyInsights: [
      "Identified primary workplace satisfaction and workload factors driving employee turnover risk.",
      "Translated statistical machine learning outputs into actionable retention risk factors.",
    ],
    businessImpact: "Delivered data-driven retention risk factors to support people management decision-making.",
    learning: "Collaborated on machine learning classification modeling and feature interpretation for organizational analytics.",
    github:
