            ...
            {stats.map((stat, i) => (
              <Reveal delay={0.15 + i * 0.1} key={stat.label}>
                <div className="glass rounded-xl2 p-6 border-l-4 border-accent hover:shadow-glow transition-all">
                  ...
                  <div className="text-sm text-ink-dim mt-2 font-mono leading-snug">
                    {stat.label}
                  </div>
                </div>
              </Reveal>
